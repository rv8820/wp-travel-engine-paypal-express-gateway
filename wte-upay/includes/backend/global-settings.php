...
<div class="wpte-field wpte-text wpte-floated">
    <label for="wp_travel_engine_settings[upay_settings][partner_id]" class="wpte-field-label">
...
<div class="wpte-field wpte-text wpte-floated">
    <label for="wp_travel_engine_settings[upay_settings][biller_uuid]" class="wpte-field-label">
